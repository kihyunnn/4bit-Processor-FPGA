...
##Pmod Header JC
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports {seg_ab[0]}]
set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports {seg_ab[1]}]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {seg_ab[2]}]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports {seg_ab[3]}]
...
##Pmod Header JD
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports {seg_ab[4]}]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {seg_ab[5]}]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports {seg_ab[6]}]
...
##Pmod Header JE
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports {seg_cd[0]}]
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports {seg_cd[1]}]
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports {seg_cd[2]}]
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports {seg_cd[3]}]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports {seg_cd[4]}]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports {seg_cd[5]}]
set_property -dict {PACKAGE_PIN T17 IOSTANDARD LVCMOS33} [get_ports {seg_cd[6]}]
...
connect_debug_port u_ila_0/probe1 [get_nets [list {mux_out[0]} {mux_out[1]} {mux_out[2]} {mux_out[3]}]]
connect_debug_port u_ila_0/probe2 [get_nets [list {alu_result[0]} {alu_result[1]} {alu_result[2]} {alu_result[3]}]]
connect_debug_port u_ila_0/probe3 [get_nets [list {reg_rd2_out[0]} {reg_rd2_out[1]} {reg_rd2_out[2]} {reg_rd2_out[3]}]]
connect_debug_port u_ila_0/probe4 [get_nets [list alu_src]]
connect_debug_port u_ila_0/probe6 [get_nets [list reg_write]]
